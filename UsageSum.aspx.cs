...
public partial class UsageSum : System.Web.UI.Page
{
    private DataTable dt;
    private string _sortDirection;
    Image sortImage = new Image();

    static string _pageSortedKey = "UsageSum_SortedView";  // 페이지의 정렬데이터 키값
    static string _pageFilterKey = "UsageSum_FilterText";  // 페이지의 필터링데이터 키값
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //SqlDataAdapter da = new SqlDataAdapter(new SqlCommand("SELECT * FROM View_Usage_Sum ORDER BY Company DESC;", dbConn));
        //dt = new DataTable();
        //da.Fill(dt);
        //GridView1.DataSource = dt;
        //GridView1.DataBind();
    ...
    {
        string sqlALL = "SELECT * FROM View_Usage_Sum ORDER BY Company DESC;";
        ...
        if (Session[_pageFilterKey] != null)
        {
            ...
            {
                string sql1 = "SELECT * FROM View_Usage_Sum ";
                string sql2 = " WHERE ";
                string sql3 = " ORDER BY Company DESC;";
